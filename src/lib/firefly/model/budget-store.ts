...
export interface BudgetStore {
     ...
     * @memberof BudgetStore
     */
    auto_budget_type?: BudgetStoreAutoBudgetTypeEnum;
    /**
     ...
     * @memberof BudgetStore
     */
    auto_budget_period?: BudgetStoreAutoBudgetPeriodEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum BudgetStoreAutoBudgetTypeEnum {
    Reset = 'reset',
    Rollover = 'rollover',
    None = 'none',
    Null = 'null'
...
/**
    ...
    * @enum {string}
    */
export enum BudgetStoreAutoBudgetPeriodEnum {
    Daily = 'daily',
    Weekly = 'weekly',
    Monthly = 'monthly',
    Quarterly = 'quarterly',
